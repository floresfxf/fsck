...
// looks through every block from block 0 up to sb.size which is number of blocks in FS, to findd block with bitmap bit =0 
//outer loop read each block of bitmap bits
